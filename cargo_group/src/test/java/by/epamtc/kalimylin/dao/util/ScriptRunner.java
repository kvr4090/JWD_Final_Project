...
public class ScriptRunner {
     ...
     * @param autoCommit  commit value
     * @param stopOnError  flag error
     */
    public ScriptRunner(Connection connection, boolean autoCommit,
        ...
        try {
            if (errorLogFile.exists()) {
                errorLogWriter = 
                		new PrintWriter(new FileWriter(errorLogFile, true));
            } else {
                errorLogWriter = 
                		new PrintWriter(new FileWriter(errorLogFile, false));
            }
        } catch(IOException e){
            System.err.println(
     ...
     * Source commands will be relative to this.
     * 
     ...
     * May be relative to the userDirectory. 
