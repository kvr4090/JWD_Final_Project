...
/**
 * The command fill request attribute list shippers, and forward to page, 
 * where user can find information about all shippers with details.
 */
public class AllShippersCommand implements Command {
	...
	public void execute(HttpServletRequest request, 
		...
		String page = PagePath.ALL_SHIPPERS;
		StringBuilder messageToLog = formMessage(logist);
		ExceptionHelper handler;
		
		try {
			List<Shipper> list = service.findAllShippers();
