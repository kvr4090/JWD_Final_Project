package by.epamtc.kalimylin.controller.command.impl.go_to.mechanic;
...
/**
 * The command forward to page, where fill data to create new requirement
 */
public class GoToNewRequirementCommand implements Command {
	...
	public void execute(HttpServletRequest request, 
		...
		request.getRequestDispatcher(
				PagePath.CREATE_REQUIREMENT).forward(request, response);
	}
	...
	private StringBuilder formMessage(User user) {
		...
		StringBuilder message = new StringBuilder()
				...
				.append(user.getId())
				.append(Message.GO_TO_NEW_REQUIREMENT_PAGE);
		return message;
	}
}